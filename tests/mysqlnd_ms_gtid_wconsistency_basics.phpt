...
if ($error = mst_create_config("test_mysqlnd_ms_gtid_wconsistency_basics.ini", $settings))
	die(sprintf("SKIP %s\n", $error));
...
--INI--
mysqlnd_ms.enable=1
mysqlnd_ms.config_file=test_mysqlnd_ms_gtid_wconsistency_basics.ini
...
--CLEAN--
<?php
	if (!unlink("test_mysqlnd_ms_gtid_wconsistency_basics.ini"))
	  printf("[clean] Cannot unlink ini file 'test_mysqlnd_ms_gtid_wconsistency_basics.ini'.\n");
