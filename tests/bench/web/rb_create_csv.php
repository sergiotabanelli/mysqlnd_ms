...
require_once('../framework/rb_storage_db_normal.php');
...
try {
  ...
  ?>
    <p>
      If you get an error like "unknown database 'microbech'", have
      a look at your <code>config.php</code>. It may be that you have configured the
      framework to use <code>MYSQL_TEST_*</code> environment variables (including name of db)
      but those variables are not set when running a script through your
      web server.
    </p>
  <?php
