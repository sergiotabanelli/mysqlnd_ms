...
PHP_TEST_SHARED_EXTENSIONS := -d 'mysqlnd_ms.master_on=' -d mysqlnd.debug=d:t:x:A,$(top_builddir)/test_mysqlnd.trace $(PHP_TEST_MYSQLND_EXTENSION)$(PHP_TEST_SHARED_EXTENSIONS)
