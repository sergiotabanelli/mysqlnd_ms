...
void mysqlnd_ms_filter_lb_weigth_dtor(_ms_hash_zval_type * pDest);
...
void mysqlnd_ms_weight_list_init(zend_llist * wl, zend_bool persistent TSRMLS_DC);
void mysqlnd_ms_weight_list_sort(zend_llist * wl TSRMLS_DC);
void mysqlnd_ms_weight_list_deinit(zend_llist * wl TSRMLS_DC);
void mysqlnd_ms_weight_list_copy(zend_llist * dst, zend_llist * src TSRMLS_DC);
